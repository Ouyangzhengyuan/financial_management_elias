...
(function () {
    ...
    function P(h) {
        var m = ((h & 16711680) >> 16).toString(16), w = ((h & 65280) >> 8).toString(16);
    ...
    function gb(h) {
        ...
        }), Ka(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : ua(h._menuButton); else if (h.exportEnabled && u) {
            var m = !1;
    ...
    function Ya(h, m, w) {
        ...
        m = !0;
        for (w = 0; 4 > w; w++) if (h[w] !== h[w + 4] | h[w] !== h[w + 8] |
            h[w] !== h[w + 12]) {
            m = !1;
            break
        }
    ...
    function ya(h, m) {
        ...
        if (s(this.options.margin) && h.options.subtitles) for (var w = h.options.subtitles, u = 0; u < w.length; u++) if ((s(w[u].horizontalAlign) && "center" === this.horizontalAlign || w[u].horizontalAlign === this.horizontalAlign) && (s(w[u].verticalAlign) && "top" === this.verticalAlign || w[u].verticalAlign === this.verticalAlign) && !w[u].dockInsidePlotArea === !this.dockInsidePlotArea) {
            this.margin = 0;
            break
        }
    ...
    var Ga = !1, S = {}, u = !!document.createElement("canvas").getContext, pa = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
            ...
            DataSeries: {
                ...
                markerColor: null,
                markerSize: null,
                markerBorderColor: u ? "transparent" :
                    null,
        ...
        Ja = {en: {}}, y = u ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
        Ea = u ? "Impact, Charcoal, sans-serif" : "Arial", za = {
    ...
    (function () {
        ...
        S._fTWm = function (h) {
            if ("undefined" === typeof S.pro.sCH && !bb) try {
                var m =
                    (new Date).getMonth() % 3, w, s, u = h[S.fSDec("buy")];
    ...
    var fb = function () {
            ...
            return function (F, N, M) {
                var H = M ? M.days : m, P = M ? M.months : s, J = M ? M.shortDays : w, R = M ? M.shortMonths : u;
                M = "";
                var S = !1;
                ...
                M = S ? "getUTC" : "get";
                var U = F[M + "Date"](), K = F[M + "Day"](), V = F[M + "Month"](), a = F[M + "FullYear"](),
            ...
            var s = 0 > h ? !0 : !1;
            s && (h *= -1);
            var u = w ? w.decimalSeparator : ".", y = w ? w.digitGroupSeparator : ",", D = "";
            m = String(m);
            var D = 1, F = w = "", N = -1, M = [], H = [], P = 0, J = 0, R = 0, S = !1, U = 0,
                F = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            m = null;
            for (var K = 0; F && K < F.length; K++) if (m = F[K], "." === m && 0 > N) N = K; else {
            ...
            h = (m[1] + "").split("");
            D && "0" === D[0] && D.shift();
            for (S = F = K = J = N = 0; 0 < M.length;) if (m = M.pop(), "#" === m || "0" ===
            m) if (N++, N === P) {
                var V = D, D = [];
                if ("0" === m) for (m = P - J - (V ? V.length : 0); 0 < m;) V.unshift("0"), m--;
                for (; 0 < V.length;) w = V.pop() + w, S++, 0 === S % F && (K === R && 0 < V.length) && (w = y + w)
            } else 0 < D.length ? (w = D.pop() + w, J++, S++) : "0" === m && (w = "0" + w, J++, S++), 0 === S % F && (K === R && 0 < D.length) && (w = y + w); else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (K++, F = S, S = 0, 0 < D.length && (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > U ? m.replace("+",
                "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function (a) {
                return X(U, a.length)
            }));
            y = "";
            ...
            return {x: m, y: w}
        }, Za = !0, Qa = window.devicePixelRatio || 1, Ma = 1, ka = Za ? Qa / Ma : 1,
        ...
        ib = bb && -1 === window[W("mnb`uhno")].href.indexOf(W("gheemd")), jb = {
    ...
    U.prototype.set = function (h, m, s) {
        ...
        if ("options" === h) this.createUserOptions(m); else if (u.hasOwnProperty(h) || u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readWrite" === u.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = m; else {
    ...
    U.prototype.updateOption = function (h) {
        ...
        var m = pa[this._defaultsKey], u = {}, y = this[h], F = this._themeOptionsKey,
            J = this._index;
    ...
    U.prototype.removeEventListener = function (h, m) {
        if (h && m && this._eventListeners[h]) for (var s = this._eventListeners[h], u = 0; u < s.length; u++) if (s[u].eventHandler === m) {
            s[u].splice(u, 1);
            break
        }
    };
    ...
    ia.prototype.render = function (h) {
        if (0 !== this.fontSize) {
            ...
            var u = 0, y = this.topPadding, F = null;
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign) u = this.width - F.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) u = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding;
    ...
    ia.prototype._getLineWithWidth = function (h, m, s) {
        ...
        var u = s = 0, y = h.length - 1, F = Infinity;
        for (this.ctx.font = this._getFontString(); u <= y;) {
            var F = Math.floor((u + y) / 2), D = h.substr(0, F + 1);
            s = this.ctx.measureText(D).width;
            if (s < m) u = F + 1; else if (s > m) y = F - 1; else break
        }
    ...
    ia.prototype._wrapText = function () {
        var h = new String(Fa(String(this.text))), m = [], s = this.ctx.font, u = 0, y = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) y = u = 0; else for (; 0 < h.length;) {
            ...
            m.push(D);
            var J = y, y = Math.max(y, D.width), u = u + D.height, h = Fa(h.slice(D.text.length, h.length));
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(),
                u = m.x1, y = m.y1, F = 0, J = 0,
                D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, H;
    ...
    y = Oa.Chart = function () {
        ...
        function y(a, d, c, b, e, f, l, v, A, k) {
            ...
            var n = 1 === Math.round(l.thickness) % 2 ? 0.5 : 0, p = 1 === Math.round(v.thickness) % 2 ? 0.5 : 0;
            a.save();
            a.globalAlpha = k;
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this._resetButton ? (ga(this._resetButton, {
                    ...
                    J(this._resetButton, "click", function () {
                        ...
                        if (a.sessionVariables.axisX) for (var b = 0; b < a.sessionVariables.axisX.length; b++) a.sessionVariables.axisX[b].newViewportMinimum = null, a.sessionVariables.axisX[b].newViewportMaximum =
                            null;
                        ...
                        if (a.sessionVariables.axisY2) for (b = 0; b < a.sessionVariables.axisY2.length; b++) a.sessionVariables.axisY2[b].newViewportMinimum = null, a.sessionVariables.axisY2[b].newViewportMaximum =
                            null;
        ...
        m.prototype.setLayout = function () {
            for (var a = this._plotAreaElements, d = 0; d < this.data.length; d++) if ("normal" ===
                ...
                if (!this.data[d].axisYType || "primary" === this.data[d].axisYType) if (this.options.axisY && 0 < this.options.axisY.length) {
                    if (!this.axisY.length) for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new D(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new D(this, "axisY", this.options.axisY[c], c, "axisY",
                        "bottom"));
                ...
                if ("secondary" === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                    if (!this.axisY2.length) for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new D(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new D(this,
                ...
                if (!this.data[d].axisXType || "primary" === this.data[d].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
                    if (!this.axisX.length) for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new D(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement &&
                ...
                if ("secondary" === this.data[d].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                    if (!this.axisX2.length) for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new D(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" ===
        ...
        m.prototype.renderElements = function () {
            ...
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" ===
                this.plotInfo.axisPlacement) D.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return;
            ...
            if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200,
                n.animationDuration, function (a) {
                    ...
                    c = [];
                    for (var a = 0; a < n.plotInfo.plotTypes.length; a++) for (var e =
                ...
                if (n._breaksCanvas) if (u) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height); else for (k = 0; k < n._axes.length; k++) n._axes[k].createMask();
        ...
        m.prototype.categoriseDataSeries = function () {
            for (var a = "", d = 0; d < this.data.length; d++) if (a =
                ...
                for (l = 0; l < c.plotUnits.length; l++) if (c.plotUnits[l].axisYType === a.axisYType && c.plotUnits[l].axisXType === a.axisXType && c.plotUnits[l].axisYIndex === a.axisYIndex &&
        ...
        m.prototype._processMultiseriesPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var v = this.data[a.dataSeriesIndexes[l]], A = 0, k = !1, n = !1, p;
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, v = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var v = this.data[a.dataSeriesIndexes[l]], A = 0, k = !1, n = !1, p = b = 0;
                ...
                for (A = 0; A < v.dataPoints.length; A++) if ("undefined" === typeof v.dataPoints[A].x && (v.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), v.dataPoints[A].x.getTime ? (f = !0, b = v.dataPoints[A].x.getTime()) : b = v.dataPoints[A].x, e = v.dataPoints[A].y,
        ...
        m.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, n = d.min, p = d.max, f = f._dataRanges,
                                         d = d._dataRanges, q, v = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                        var h = e.data[a.dataSeriesIndexes[A]];
                        if (!(4 > h.dataPoints.length)) for (v = 0; v < h.dataPoints.length; v++) if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[v].x.getTime ? h.dataPoints[v].x.getTime() : h.dataPoints[v].x, q = Math.floor((g - k) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                            var m = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                            if ((g = "waterfall" ===
                            a.type ? h.dataPointEOs[v].cumulativeSum : h.dataPoints[v].y) && g.length) for (var u = 0; u < g.length; u++) q = Math.floor((g[u] - n) / m), g[u] < d[q].min && (d[q].min = g[u]), g[u] > d[q].max && (d[q].max = g[u]); else s(g) || (q = Math.floor((g - n) / m), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                        }
                    }
                }
            }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges,
                    ...
                    if (!(4 > n.dataPoints.length)) for (k = 0; k < n.dataPoints.length; k++) g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = n.dataPoints[k].x.getTime ? n.dataPoints[k].x.getTime() : n.dataPoints[k].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b)
                }
            }
            ...
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++) for (f = this.plotInfo.plotTypes[l], v = 0; v < f.plotUnits.length; v++) b = f.plotUnits[v], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" ===
                ...
                for (l = 0; l < this._axes.length; l++) if (this._axes[l].dataInfo._dataRanges) {
                    ...
                    if (this._axes[l].dataInfo.dataPointYPositiveSums) {
                        ...
                        n = k;
                        for (v in q) if (q.hasOwnProperty(v) && !isNaN(v) && (p = q[v], !s(p))) {
                    ...
                    for (v = 0; v < k.length - 1; v++) if (n = k[v].max, isFinite(n)) for (; v < k.length - 1;) if (A = k[v + 1].min, isFinite(A)) {
                        p = A - n;
                        p > b && f.push({diff: p, start: n, end: A});
                        break
                    } else v++;
                    if (this._axes[l].scaleBreaks.customBreaks) for (v = 0; v < this._axes[l].scaleBreaks.customBreaks.length; v++) for (b = 0; b < f.length; b++) if (this._axes[l].scaleBreaks.customBreaks[v].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[v].endValue ||
        ...
        m.prototype.getObjectAtXY = function (a, d, c) {
            var b = null;
            if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (u) b = Ya(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        ...
        m.prototype._plotAreaMouseUp = function (a, d) {
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if ("xySwapped" === this.plotInfo.axisPlacement) var v = f, f = e, e = v;
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                this.resetOverlayedCanvas();
                if (this.axisX && 0 < this.axisX.length) for (l = 0; l < this.axisX.length; l++) this.axisX[l].crosshair &&
                ...
                if (this.axisY2 && 0 < this.axisY2.length) for (l = 0; l < this.axisY2.length; l++) this.axisY2[l].crosshair && this.axisY2[l].crosshair.enabled &&
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff)) if (r =
        ...
        m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea, b = 0, e = 0, f = 0, l = f = e = 0, v = 0, A = b = 0,
                k = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                var n = this._indexLabels[a], p = n.chartType.toLowerCase(), q, g,
                    ...
                    k = la("indexLabelFontWeight", n.dataPoint,
                        n.dataSeries), h = la("indexLabelBackgroundColor", n.dataPoint, n.dataSeries);
                ...
                var m = la("indexLabelLineDashType", n.dataPoint, n.dataSeries),
                    ...
                    b = 0 < x ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ?
                        this.plotArea.height : this.plotArea.width) << 0) : 0, E = {percent: null, total: null},
                    B = null;
                ...
                if (null !== C && "" !== C) {
                    var E = la("indexLabelPlacement", n.dataPoint, n.dataSeries),
                        ...
                        z = la("indexLabelTextAlign", n.dataPoint, n.dataSeries), w = n.direction,
                        e = n.dataSeries.axisX,
                        f = n.dataSeries.axisY, y = !1, h = new ia(d, {
                            x: 0,
                            y: 0,
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) E = "auto", v = 4; else if (0 <= p.indexOf("stacked")) "auto" === E && (E = "inside"); else if ("bubble" === p || "scatter" === p) E = "inside";
        ...
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var A = a.dataSeriesIndexes[v], k = this.data[A];
                    ...
                    c.beginPath();
                    if (0 < n.length) {
                        for (var B = !1, t = 0; t < n.length; t++) if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                            !B))) if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || B || m) && (c.stroke(), u && b.stroke()), B = !0; else {
                ...
                for (var f = [], l, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (c.setLineDash) {
                        var q = N(k.nullDataLineDashType,
                            k.lineThickness), p = k.lineDashType, g = N(p, k.lineThickness);
                        c.setLineDash(g)
                    }
                    var r = k.id;
                    this._eventManager.objectMap[r] = {objectType: "dataSeries", dataSeriesIndex: A};
                    ...
                    c.beginPath();
                    if (0 < n.length) {
                        for (var B = !1, t = 0; t < n.length; t++) if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                            (!k.connectNullData || !B))) if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || B || m) && (c.stroke(), u && b.stroke()), B = !0; else {
                            var C = s;
                            x = a.axisX.convertValueToPixel(x);
                            s = a.axisY.convertValueToPixel(n[t].y);
                            ...
                            if (0 < n[t].markerSize || 0 < k.markerSize) C = k.getMarkerProperties(t, x, s, c), f.push(C), z = P(z), u && f.push({
                                x: x,
                                y: s,
                                ctx: b,
                                type: C.type,
        ...
        m.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    var m = 0, t, x, s = [];
                    b.beginPath();
                    if (0 < n.length) for (x = !1, m = 0; m < n.length; m++) if (t = n[m].getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x))) if ("number" !== typeof n[m].y) 0 < m && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length -
        ...
        m.prototype.renderColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, v, A,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < r.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f =
                        ...
                        var m = a.axisX.reversed ? l - p << 0 : l + p << 0, t;
                        0 <= r[f].y ? t = k : (t = v, v = k);
                        v > t && (b = v, v = t, t = b);
        ...
        m.prototype.renderStackedColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], v = [], A = [], k = 0, n, p,
                    q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k =
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var h =
                        a.dataSeriesIndexes[r], m = this.data[h], t = m.dataPoints;
                    if (0 < t.length) {
                        ...
                        for (k = 0; k < t.length; k++) if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                            ...
                            var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = s + g << 0, C;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) v[b] = t[k].y + (v[b] ? v[b] :
                                0), 0 < v[b] && (p = a.axisY.convertValueToPixel(v[b]), C = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = t[k].y + (A[b] ? A[b] : 0), C = a.axisY.convertValueToPixel(A[b]), p = "undefined" !== typeof l[b] ? l[b] : q, l[b] = C; else if (p = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) {
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var h =
                        a.dataSeriesIndexes[r], m = this.data[h], t = m.dataPoints;
                    if (0 < t.length) for (var x = 5 < g && m.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++) if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                        n = a.axisX.convertValueToPixel(b);
        ...
        m.prototype.renderBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                        null, e = this.plotArea, f = 0, l, v, A,
                    k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < r.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < r.length; f++) if (r[f].getTime ? A = r[f].x.getTime() : A = r[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                            ...
                            var m = a.axisX.reversed ? v - p << 0 : v + p << 0, t;
                            0 <= r[f].y ? t = k : (t = l, l = k);
                            b = r[f].color ? r[f].color : g._colorSet[f % g._colorSet.length];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < t.length) {
                        var x = 5 < g && m.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (k = 0; k < t.length; k++) if (b = t[k].x.getTime ? t[k].x.getTime() :
                            t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                            p = a.axisX.convertValueToPixel(b);
                            var s = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = s + g << 0, C;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) v[b] = t[k].y + (v[b] ? v[b] : 0), 0 < v[b] && (C = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(v[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = t[k].y + (A[b] ? A[b] : 0), n = l[b] ?
                                l[b] : q, l[b] = C = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) {
                                var z = f[b] ? f[b] : 0;
                                C = q + z;
                                n += z;
                                f[b] = z + (n - C)
        ...
        m.prototype.renderStackedBar100 = function (a) {
            var d =
                a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], v = [], A = [], k = 0, n, p,
                    q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < t.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (k = 0; k < t.length; k++) if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                        "number" === typeof t[k].y) {
                            p = a.axisX.convertValueToPixel(b);
                            var E;
                            E = 0 !== a.dataPointYSums[b] ? 100 * (t[k].y / a.dataPointYSums[b]) : 0;
                            var B = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, C = B + g << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) {
                                ...
                                q, l[b] = E = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(E), 0 <= t[k].y) {
                                var z = f[b] ? f[b] : 0;
                                E = q + z;
                                n += z;
                            ...
                            this._eventManager.objectMap[b] = {
                                ...
                                dataPointIndex: k, x1: E, y1: B, x2: n, y2: C
                            };
                            b = P(b);
        ...
        m.prototype.renderArea = function (a) {
            ...
            var e = a.targetCanvasCtx || this.plotArea.ctx, f = u ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var l = this._eventManager.ghostCtx, v = a.axisY.lineCoordinates, A = [], k = this.plotArea, n;
                f.save();
                u && l.save();
                f.beginPath();
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p], g = this.data[q], r = g.dataPoints, A = g.id;
                    ...
                    d = !0;
                    var h = 0, m, t, s,
                        E = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), B, C = null;
                    if (0 < r.length) {
                        var z = g._colorSet[h % g._colorSet.length], w = g.lineColor = g.options.lineColor || z, y = w;
                        f.fillStyle = z;
                        f.strokeStyle = w;
                        ...
                        for (var ja = !0; h < r.length; h++) if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s <
                            ...
                            d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, C = n, c = g.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(m, t), u && l.lineTo(m, t)) :
                                (f.beginPath(), f.moveTo(m, t), u && (l.beginPath(), l.moveTo(m, t)), C = {
                                    x: m,
                                    y: t
                            ...
                            0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, m, t, f), A.push(s), Y = P(Y), u && A.push({
                                x: m,
                                y: t,
                                ctx: l,
                                type: s.type,
        ...
        m.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), u && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(),
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, l = [], v = this.plotArea;
                b.save();
                u && e.save();
                b.beginPath();
                b.rect(v.x1,
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var k = a.dataSeriesIndexes[A], n = this.data[k], p = n.dataPoints, l = n.id;
                    this._eventManager.objectMap[l] = {objectType: "dataSeries", dataSeriesIndex: k};
                    l = P(l);
                    e.fillStyle = l;
                    var l = [], q = 0, g, r,
                        h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, t = null,
                        s = [];
                    if (0 < p.length) {
                        var E = n._colorSet[q % n._colorSet.length], B = n.lineColor = n.options.lineColor ||
                            E, C = B;
                        b.fillStyle = E;
                        b.strokeStyle = B;
                        ...
                        var z = "solid";
                        if (b.setLineDash) {
                            var y = N(n.nullDataLineDashType, n.lineThickness), z = n.lineDashType,
                                D = N(z, n.lineThickness);
                            b.setLineDash(D)
                        }
                        for (r = !1; q < p.length; q++) if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r))) if ("number" !== typeof p[q].y) 0 < q && !r && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) &&
                            (s[s.length - 1].newLineDashArray = y, z = n.nullDataLineDashType) : (d(), s = [])), r = !0; else {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var q = a.dataSeriesIndexes[p],
                        g = this.data[q], r = g.dataPoints, A = g.id;
                    this._eventManager.objectMap[A] = {objectType: "dataSeries", dataSeriesIndex: q};
                    A = P(A);
                    l.fillStyle = A;
                    A = [];
                    ...
                    if (0 < r.length) {
                        ...
                        for (; h < r.length; h++) if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                            ...
                            "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || Q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(),
                                f.moveTo(n.x, n.y), m = d, t = c, C = n, Q = g.nullDataLineDashType, f.setLineDash(aa)), f.lineTo(m, Y), f.lineTo(m, t), u && (l.lineTo(m, Y), l.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), u && (l.beginPath(), l.moveTo(m, t)), C = {
                                x: m,
                                y: t
                            }), c = d = !1) : (f.lineTo(m, Y), u && l.lineTo(m, Y), f.lineTo(m, t), u && l.lineTo(m, t), 0 == h % 250 && b()), n = {
                                x: m,
                                y: t
                            }, h < r.length - 1 && (y !== (r[h].lineColor || w) || Q !== (r[h].lineDashType || g.lineDashType)) && (b(), y = r[h].lineColor || w, f.strokeStyle = y, f.setLineDash && (r[h].lineDashType ? (Q = r[h].lineDashType, f.setLineDash(N(Q,
                                g.lineThickness))) : (Q = g.lineDashType, f.setLineDash(D)))), s = g.dataPointIds[h], this._eventManager.objectMap[s] = {
                                id: s,
                                objectType: "dataPoint",
                                dataSeriesIndex: q,
                                dataPointIndex: h,
                                x1: m,
                                y1: t
                            }, 0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (Y = g.getMarkerProperties(h, m, t, f), A.push(Y), s = P(s), u && A.push({
                                x: m,
                                y: t,
                                ctx: l,
                                type: Y.type,
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            var c =
                a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = [], v = this.plotArea, h = [], k = [], n = [], p = [], q = 0, g, r,
                    m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    s = this._eventManager.ghostCtx, t, x, E;
                u && s.beginPath();
                b.save();
                u && s.save();
                b.beginPath();
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    s.fillStyle = q;
                    if (0 < n.length) {
                        var e = z._colorSet[0], y = z.lineColor = z.options.lineColor || e, Q = y;
                        b.fillStyle = e;
                        b.strokeStyle = y;
                        b.lineWidth =
                            z.lineThickness;
                        ...
                        for (var Y = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y))) if ("number" !== typeof fa.y) z.connectNullData || (Y || x) || d(), Y = !0; else {
                                ...
                                x || Y ? (!x && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || E === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(), E = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(E), k.push(x), E = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g,
                                    r), u && s.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), u && (s.beginPath(), s.moveTo(g, r))), Y = x = !1) : (b.lineTo(g, r), u && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), u && s.moveTo(g, r), k.push({
                                    x: g,
                                    y: m - ma
                                })));
                                t = {x: g, y: r};
                                q < w.length - 1 && (Q !== (w[q].lineColor || y) || E !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({
                                    x: g,
                                    y: m - ma
                                }), Q = w[q].lineColor || y, b.strokeStyle = Q, b.setLineDash && (w[q].lineDashType ? (E = w[q].lineDashType, b.setLineDash(N(E, z.lineThickness))) : (E = z.lineDashType, b.setLineDash(D))));
                                ...
                                0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b), l.push(ma), f = P(F), u && l.push({
                                    x: g,
                                    y: r,
                                    ctx: s,
                                    type: ma.type,
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, v = [], h = [], k = [], n = [], p = [], q = 0, g, r, m, s, t,
                ...
                for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var w = a.dataSeriesIndexes[B], z = this.data[w], y = z.dataPoints;
                    z.dataPointIndexes = [];
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    if (0 < n.length) {
                        var e = z._colorSet[q %
                        z._colorSet.length], D = z.lineColor = z.options.lineColor || e, Q = D;
                        b.fillStyle = e;
                        b.strokeStyle = D;
                        ...
                        for (var Y = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y))) if ("number" !== typeof fa.y) z.connectNullData ||
                            (Y || s) || d(), Y = !0; else {
                                var ma;
                                ...
                                s || Y ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType &&
                                    z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(t), k.push(s), t = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(g, r), u && E.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), u && (E.beginPath(), E.moveTo(g, r))), Y = s = !1) : (b.lineTo(g, r), u && E.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), u && E.moveTo(g, r), k.push({
                                    x: g,
                                    y: x - ba
                                })));
                                m = {x: g, y: r};
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var v = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints,
        ...
        m.prototype.renderScatter = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var h = a.dataSeriesIndexes[v], k = this.data[h], n = k.dataPoints;
                    if (0 < n.length) {
                        c.strokeStyle = "#4572A7 ";
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++) if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                            ...
                            Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width,
                                ...
                                x1: f,
                                y1: l
                            }, p = P(p), u && V.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel || n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: n[e],
                                dataSeries: k,
                                point: {x: f, y: l},
        ...
        m.prototype.renderCandlestick = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, l = this.plotArea, v = 0, h, k, n, p, q, g,
                    ...
                    f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                        this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < x.length) for (var E = 5 < r && t.bevelEnabled ? !0 : !1, v = 0; v < x.length; v++) if (x[v].getTime ? g = x[v].x.getTime() : g = x[v].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[v].y) && x[v].y.length && "number" === typeof x[v].y[0] &&
                    "number" === typeof x[v].y[1] && "number" === typeof x[v].y[2] && "number" === typeof x[v].y[3]) {
                        ...
                        var B = h - r / 2 << 0, C = B + r << 0,
                            f = t.options.fallingColor ? t.fallingColor : t._colorSet[0],
                            e = x[v].color ? x[v].color : t._colorSet[0], z = Math.round(Math.max(1, 0.15 * r)),
                            y = 0 === z % 2 ? 0 : 0.5, D = t.dataPointIds[v];
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var t = a.dataSeriesIndexes[w], x = this.data[t], E = x.dataPoints;
                    if (0 < E.length) for (var B = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < E.length; l++) if (E[l].getTime ? g = E[l].x.getTime() : g = E[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(E[l].y) && E[l].y.length && "number" === typeof E[l].y[0] && "number" === typeof E[l].y[1] && "number" === typeof E[l].y[2] && "number" === typeof E[l].y[3] && "number" === typeof E[l].y[4] && 5 === E[l].y.length) {
                        ...
                        var C = v - r / 2 << 0, z = v + r / 2 << 0, e = E[l].color ? E[l].color : x._colorSet[0],
                            y = Math.round(Math.max(1, 0.15 * r)), D = 0 === y % 2 ? 0 : 0.5,
                            ...
                            G = 1 === Math.round(ba) % 2 ? 0.5 : 0, J = E[l].stemDashType ? E[l].stemDashType :
                            x.stemDashType,
                            ...
                            L = 1 === Math.round(M) % 2 ? 0.5 : 0, R = x.upperBoxColor, xa = x.lowerBoxColor,
                            sa = s(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[l];
        ...
        m.prototype.renderRangeColumn = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, v, h,
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length) for (var r =
                        ...
                        var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + n) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                            n) * k << 0, w = a.axisX.reversed ? m - k << 0 : m + k << 0,
        ...
        m.prototype.renderError =
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var e = null, f = !1, l = this.plotArea, v = 0, h, k, n, p, q, g, r, m = a.axisX.dataInfo.minDiff;
                    ...
                    for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                        var E = a.dataSeriesIndexes[x], B = this.data[E], C = B.dataPoints,
                            z = s(B._linkedSeries) ? !1 : B._linkedSeries.type.match(/(bar|column)/ig) && B._linkedSeries.visible ? !0 : !1,
                            D = 0;
                        if (z) for (e = B._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) ||
                        ...
                        (t = e);
                        t > v && (t = v);
                        if (0 < C.length) for (var F = B._colorSet, v = 0; v < C.length; v++) {
                            var e = B.lineColor = B.options.color ? B.options.color : F[0], Q = {
        ...
        m.prototype.renderRangeBar = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx :
                d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, v, h, k,
                    f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
        ...
        m.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var m = [], k = a.dataSeriesIndexes[h], n = this.data[k], p = n.dataPoints, f = n.id;
                    this._eventManager.objectMap[f] = {objectType: "dataSeries", dataSeriesIndex: k};
                    f = P(f);
                    e.fillStyle = f;
                    var f = [], q = !0, g = 0, r, s, w, t, x = null;
                    if (0 < p.length) {
                        var E = n._colorSet[g % n._colorSet.length], B = n.lineColor = n.options.lineColor || E, C = B;
                        b.fillStyle = E;
                        b.strokeStyle = B;
                        b.lineWidth = n.lineThickness;
                        var z = "solid";
                        if (b.setLineDash) {
                            var y = N(n.nullDataLineDashType, n.lineThickness), z = n.lineDashType, D = N(z,
                                n.lineThickness);
                            b.setLineDash(D)
                        }
                        for (var Q = !0; g < p.length; g++) if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !Q))) if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                            ...
                            q || Q ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType &&
                                ...
                                y1: s,
                                y2: w
                            })) : (b.beginPath(), b.moveTo(r, s), x = {x: r, y: s}, m = [], m.push({
                                x: r,
                                y1: s,
                                y2: w
                            }), u && (e.beginPath(), e.moveTo(r, s))), Q = q = !1) : (b.lineTo(r, s), m.push({
                                x: r,
                                y1: s,
                                y2: w
        ...
        m.prototype.renderRangeSplineArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                u && (e.beginPath(), e.rect(l.x1, l.y1, l.width, l.height), e.clip());
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var m = a.dataSeriesIndexes[h], k = this.data[m], n = k.dataPoints, f = k.id;
                    this._eventManager.objectMap[f] =
                        {objectType: "dataSeries", dataSeriesIndex: m};
                    f = P(f);
                    e.fillStyle = f;
                    var f = [], p = 0, q, g, r, s = [], y = [];
                    if (0 < n.length) {
                        var t = k._colorSet[p % k._colorSet.length], x = k.lineColor = k.options.lineColor || t, E = x;
                        b.fillStyle = t;
                        b.lineWidth = k.lineThickness;
                        var B = "solid", C;
                        if (b.setLineDash) {
                            var z = N(k.nullDataLineDashType, k.lineThickness), B = k.lineDashType;
                            C = N(B, k.lineThickness)
                        }
                        for (g = !1; p < n.length; p++) if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
        ...
        m.prototype.renderWaterfall = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, l = 0, h, m, k, n,
                    p = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var r = a.dataSeriesIndexes[g], s = this.data[r], w = s.dataPoints, e = s._colorSet[0];
                    ...
                    if (0 < w.length) for (var E = 5 < q && s.bevelEnabled ? !0 : !1, B = !1, y = null, z = null, l = 0; l < w.length; l++) if (w[l].getTime ?
        ...
        m.prototype.renderPie = function (a) {
            function d() {
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        var p = g[e], h = {percent: null, total: null}, v = null, h = m.getPercentAndTotal(k, f);
                        ...
                        p.indexLabelTextBlock = new ia(m.plotArea.ctx, {
                            ...
                            maxHeight: p.indexLabelWrap ? 5 * p.indexLabelFontSize :
            ...
            function c(a) {
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * z * Math.cos(g[b].midAngle), f = 0.07 * z * Math.sin(g[b].midAngle), l = !1;
                        if (n[b].exploded) {
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    ...
                    l = null;
                    for (p = 1; p < n.length; p++) if (l = (a - p + g.length) % g.length, g[l].hemisphere !== g[a].hemisphere) {
                        l = null;
                        break
                    } else if (g[l].indexLabelText && g[l].hemisphere ===
                        g[a].hemisphere && l !== a && (0 > b(g[l], g[a]) || ("right" === g[a].hemisphere ? g[l].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[l].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break; else l = null;
                    m = l;
                    q = e(a);
                    p = l = 0;
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    } else for (a = 0; a < n.length; a++) h = g[a], u = "pie" === k.type ? 0.7 * z : 0.8 * z, t = E.x + u * Math.cos(h.midAngle), s = E.y + u * Math.sin(h.midAngle), h.indexLabelTextBlock.x = t, h.indexLabelTextBlock.y = s;
                    ...
                    (function () {
                        for (var a = -1, c = -1, d = 0, f = !1, k = 0; k < n.length; k++) if (f = !1, v = g[k], v.indexLabelText) {
                            var l = e(k);
                            if (null !== l) {
                                var h = g[l];
                                B = 0;
                                ...
                                if (q = 0 > B) {
                                    ...
                                    var m = v.indexLabelTextBlock.y - v.indexLabelTextBlock.height /
                                        2, r = v.indexLabelTextBlock.y + v.indexLabelTextBlock.height / 2,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k =
                    ...
                    r = 2, u, w = 1.3, t = 20 / 180 * Math.PI, x = 6, E = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2},
                    B = 0;
                a = !1;
        ...
        m.prototype.renderFunnel =
            function (a) {
                ...
                function e() {
                    ...
                    if (e) for (l = I.length - 1; 0 <= l; l--) a = O[l], I[l].textBlock.maxWidth = f[f.length - (l + 1)], I[l].textBlock.measureText(), I[l].textBlock.x = M - k, c = I[l].textBlock.height < I[l].textBlock.maxHeight ? I[l].textBlock.height :
                ...
                function l() {
                    ...
                    function c(a, b, d) {
                        ...
                        for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++, f += I[b.id].height + da, I[b.id].textBlock.text = "", I[b.id].indexLabelText = "", I[b.id].isDirty = !0, I[b.id].textBlock.measureText(); else break;
                        return g
                    }
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    var H = E.x1 + C, M = E.x2 - C, Y = E.y1 + B, P = E.y2 - B,
                    ...
                    if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                        ...
                        var C = H + a / 2, X = H, Z = H + a, na = t.reversed ? P : Y, L = C - G / 2, V = C + G / 2,
                            xa = t.reversed ? Y + ba : P - ba, sa = t.reversed ? Y : P;
                        a = [];
                        var C = [], O = [], F = [], T = Y, ca, $ = (xa - na) / (L - X), ea = -$,
                            H = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d();
                        if (-1 !== H) {
                            if (t.reversed) for (F.push(T),
                                                     G = H.length - 1; 0 < G; G--) T += H[G], F.push(T); else for (G = 0; G < H.length; G++) T += H[G], F.push(T);
                            if (t.reversed) for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), C.push(V), ca = G) : (a.push((F[G] - na + $ * X) / $), C.push((F[G] - na + ea * Z) / ea)); else for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * X) / $), C.push((F[G] - na + ea * Z) / ea), ca = G) : (a.push(L), C.push(V));
                            ...
                            if (J && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
                                l();
                            ...
                            if (!J) for (G = 0; G < x.length; G++) z = t.dataPointIds[G],
                                a = {
                                    id: z,
                                    objectType: "dataPoint",
                                    dataPointIndex: G,
        ...
        m.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var l = "#percent", h = "#total", m = this.getPercentAndTotal(c, d), h = isNaN(m.total) ? h : m.total,
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                ...
                } else return ea(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" === a ? ea(g, d.yValueFormatString ?
                ...
                if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                    ...
                    var y = p.dataPoints[x],
                        ...
                        g = y.legendText ? y.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            ...
                            dataSeries: p,
                            dataPoint: y
                        }) : y.name ? y.name : "DataPoint: " + (x + 1), r = y.legendMarkerColor ? y.legendMarkerColor :
        ...
        F.prototype.render = function () {
            ...
            for (var h = 0, m = 0; m < l.length; m++) {
                for (var k = l[m], n = 0, p = 0; p < k.items.length; p++) {
                    var q = k.items[p], g = q.textBlock.x + a + (0 === p ? 0.2 * f : this.horizontalSpacing),
                        r = d + h, s = g;
                    ...
                    if ("error" === q.chartType) {
                        ...
                        this.ctx.beginPath();
                        var u = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, t = r + 0.15 * this.lineHeight,
                            x = 0.7 * this.lineHeight, w = x + 0.02 * this.lineHeight;
                        this.ctx.moveTo(u, t);
        ...
        H.prototype.getDataPointAtX = function (a, d) {
            ...
            var c = {
                ...
                index: NaN
            }, b = null, e = 0, f = 0, l = 1, h = Infinity, m = 0, k = 0, n = 0;
        ...
        H.prototype.getDataPointAtXY = function (a, d, c) {
            ...
            c = c || !1;
            var b = [], e = 0, f = 0, l = 1, h = !1, m = Infinity, k = 0, n = 0, p = 0;
            if ("none" !== this.chart.plotInfo.axisPlacement) if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
                ...
                p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p /
                    this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (p - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (; ;) {
                f = 0 < l ? p + e : p - e;
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "splineArea":
                            case "scatter":
                                var s = la("markerSize", g, this) || 4, u = c ? 20 : s,
        ...
        D.prototype.createLabels = function () {
            var a, d, c = 0, b = 0, e, f = 0, l = 0, b = 0, b = this.interval, h = 0, m, k = 0.6 * this.chart.height, n;
            a = !1;
            ...
            "top" === this._position) if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
                    ...
                    if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (k - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI /
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks &&
                q[g].scaleBreaks._appliedBreaks.length) for (var r = q[g].scaleBreaks._appliedBreaks, u = 0; u < r.length && !(r[u].startValue > q[g].viewportMaximum); u++) r[u].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = u), r[u].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = u));
            ...
            if ("normal" === e) {
                ...
                u;) {
                    var G = 0, S = 0, U = 0, X = 0, W = e = 0, L = 0, Z = 0, T = 0, V = 0, O = 0, $ = 0;
                    if (c && 0 < c.length) for (B = [], g = O = 0; g < c.length; g++) B.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += B[g], L += c[g] && !n.isNavigator ? c[g].margin : 0; else B.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(B);
                    if (b && 0 < b.length) for (C = [], g = $ = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), $ += C[g], Z += b[g] ? b[g].margin : 0; else C.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    R.push(C);
                    l = Math.round(f.x1 + O + L);
                    m = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z);
                    if (a && 0 < a.length) for (x = [], g = T = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(m - l), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), x.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), T += x[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                        0));
                    M.push(x);
                    if (d && 0 < d.length) for (y = [], g = V = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(m - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), y.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), V += y[g], W += d[g] && !n.isNavigator ? d[g].margin : 0; else y.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(y);
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + L), d[g].lineCoordinates.x2 =
                    ...
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W), L = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + L)), b[g].lineCoordinates =
                        {
                            x1: l + X,
                            y1: h,
                            x2: l + X,
                    ...
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (z = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" ===
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (z = (d[g].logarithmic ?
                    ...
                    if (0 < u) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) r = M[u - 1][g] === M[u][g] ? !0 : !1; else r = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) H = N[u - 1][g] === N[u][g] ? !0 : !1; else H = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[u - 1][g] === P[u][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = R[u -
                        1][g] === R[u][g] ? !0 : !1; else K = !0
                    }
                    if (r && H && J && K) break;
                    u++
                }
                ...
                for (N = []; 4 > u;) {
                    ...
                    if (a && 0 < a.length) for (F = [], g = X = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), X += F[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length) for (w = [], g = T = 0; g < d.length; g++) w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), T += w[g], W += d[g] ? d[g].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(w);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - T - W > n.width - 10 ? n.width - 10 : f.x2 - T - W), c[g].labelAutoFit && !s(x) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - y / 2 : 0 === c[g].labelAngle ? m - y / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                    c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - T - W > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - T - W), b[g] && b[g].labelAutoFit && !s(B) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, B) : 0 === b[g].labelAngle ? Math.max(l, B / 2) : l), 0 < !d.length && (m -= C / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
                        0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    if (c && 0 < c.length) for (p = [], g = U = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), U += p[g] + c[g].margin, L += c[g].margin; else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    D.push(p);
                    if (b && 0 < b.length) for (z = [], g = S = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), S += z[g], Z += b[g].margin; else z.push(Math.ceil(b[0] ?
                    ...
                    if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + V), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + V), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" ===
                    ...
                    if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (z[g] + b[g].margin + G)), b[g].lineCoordinates.y1 =
                    ...
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                        ...
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, x) : 0 === c[L].labelAngle ? Math.max(m, x / 2) : m, l =
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                        ...
                        k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2 - U) : f.y2 > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2;
                        if (c && 0 < c.length) for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (m = 0 > c[L].labelAngle ? Math.max(m, x) : 0 === c[L].labelAngle ? Math.max(m, x / 2) : m, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? m - T : l);
                        if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] &&
                    ...
                    if (0 < u) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) r = M[u - 1][g] === M[u][g] ? !0 : !1; else r = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) H = N[u - 1][g] === N[u][g] ? !0 :
                            !1; else H = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = D[u - 1][g] === D[u][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = t[u - 1][g] === t[u][g] ? !0 : !1; else K = !0
                    }
                    if (r && H && J && K) break;
                    u++
                }
        ...
        D.prototype.renderAxisLine = function () {
            var a = this.chart.ctx, d = u ? this.chart._preRenderCtx : a,
        ...
        T.prototype.render = function (a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                var d =
                    this.ctx, c = this.ctx.globalAlpha;
                this.ctx = a || this.ctx;
                this.ctx.save();
                this.ctx.beginPath();
                this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, l = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, h = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, h = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = {
                    x1: b - p / 2,
                    y1: e,
                    x2: l + p / 2,
                    y2: h
                }, this.ctx.moveTo(b,
                    e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, h), this.ctx.lineTo(l, h), this.ctx.lineTo(l, e); else if ("wavy" === this.type) {
                    m = b;
                    k = e;
                    f = 0.5;
                    n = (h - k) / a / 3;
        ...
        $.prototype.showAt = function (a) {
            ...
            if ("xySwapped" === d.plotInfo.axisPlacement) if ("bottom" === this.parent._position) for (var b = 0; b < d.axisY.length; b++) this.parent === d.axisY[b] && (d.axisY[b]._crosshairValue = a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum ? a : null); else if ("top" === this.parent._position) for (b = 0; b < d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ?
                a : null); else if ("left" === this.parent._position) for (b = 0; b < d.axisX.length; b++) this.parent === d.axisX[b] && (d.axisX[b]._crosshairValue = a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum ? a : null); else {
            ...
            } else if ("bottom" === this.parent._position) for (b = 0; b < d.axisX.length; b++) this.parent === d.axisX[b] && (d.axisX[b]._crosshairValue =
        ...
        $.prototype.render = function (a, d, c) {
            ...
            var k = null === this.opacity ? 1 : this.opacity,
                ...
                q = this.chart.overlaidCanvasCtx, g = q.globalAlpha;
            q.globalAlpha = k;
            q.beginPath();
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    t < u && (u = t, w = r); else t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < u && (u = t, w = r);
                    x = n[w];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        B = !1;
                        if (this.parent.labels) for (n = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += n) if (this.parent.labels[r]) B = !0; else {
                            B = !1;
                            break
                        }
                        if (B) {
                            if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({y: d}), u = null, w = 0; w < this.parent.dataSeries.length; w++) (u =
                    ...
                    if (B) {
                        if ("axisX" ===
                            this.parent.type) for (r = this.parent.convertPixelToValue({x: a}), u = null, w = 0; w < this.parent.dataSeries.length; w++) (u = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= u.index && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.x
                    ...
                    w = 0;
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])),
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                    ...
                    if (B) {
                        if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({y: d}), u = null, w = 0; w < this.parent.dataSeries.length; w++) (u = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= u.index &&
                        (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                    ...
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval),
                                                     r = 0; r < this.parent.viewportMaximum; r += n) if (this.parent.labels[r]) B = !0; else {
                        B = !1;
                        break
                    }
                    if (B) {
                        if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({x: a}), u = null, w = 0; w < this.parent.dataSeries.length; w++) (u = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= u.index && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        h = [];
                        if (this.chart.axisX) for (m = 0; m < this.chart.axisX.length; m++) for (l = this.chart.axisX[m].convertPixelToValue({x: a}), k = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++) (k = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[m].dataSeries[b], null !== k.dataPoint.y && h.push(k));
                    ...
                    if (k = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex =
                        k.dataSeries.index; else if (u) if (k = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) {
                ...
                if (0 < f.length) {
                    ...
                    if (this.enabled) {
                        var n = "", n = this.getToolTipInnerHTML({entries: f});
                        if (null !== n) {
        ...
        X.prototype.getToolTipInnerHTML = function (a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", h = !0, m = 0; m < a.length; m++) if (a[m].dataSeries.toolTipContent ||
