...
//        autoGenerator.setPackageInfo(initPackageConfig(null));
//        autoGenerator.setCfg(initInjectionConfig(projectPath, null));
...
//        Props props = new Props("mybatis/generatorConfig/generator.properties");
